""
" Lightline_theme: asteroid-lightline
...
let s:p.normal.right = [[["#7f8490", 102], ["#2c2e34", 236]], [["#181819", 234], ["#fc5d7c", 204]]]
...
let s:p.inactive.right = [[["#7f8490", 102], ["#2c2e34", 236]], [["#33353f", 237], ["#4f5462", 240]]]

let s:p.insert.left = [[["#181819", 234], ["#7eb2dd", 110]], [["#7f8490", 102], ["#2c2e34", 236]]]
let s:p.insert.middle = [[["#4f5462", 240], ["#1b1b1c", 234]]]
let s:p.insert.right = [[["#7f8490", 102], ["#2c2e34", 236]], [["#181819", 234], ["#7eb2dd", 110]]]

let s:p.replace.left = [[["#181819", 234], ["#9c8cc3", 139]], [["#7f8490", 102], ["#2c2e34", 236]]]
let s:p.replace.middle = [[["#4f5462", 240], ["#1b1b1c", 234]]]
let s:p.replace.right = [[["#7f8490", 102], ["#2c2e34", 236]], [["#181819", 234], ["#9c8cc3", 139]]]

let s:p.visual.left = [[["#181819", 234], ["#f39660", 209]], [["#7f8490", 102], ["#2c2e34", 236]]]
let s:p.visual.middle = [[["#4f5462", 240], ["#1b1b1c", 234]]]
let s:p.visual.right = [[["#7f8490", 102], ["#2c2e34", 236]], [["#181819", 234], ["#f39660", 209]]]

let s:p.tabline.left = [[["#7f8490", 102], ["#121213", 233]]]
let s:p.tabline.tabsel = [[["#56eded", 87], ["#121213", 233]]]
let s:p.tabline.middle = [[["#4f5462", 240], ["#1b1b1c", 234]]]
let s:p.tabline.right = [[["#7f8490", 102], ["#121213", 233]]]

let g:lightline#colorscheme#asteroid-lightline#palette = lightline#colorscheme#flatten(s:p)
