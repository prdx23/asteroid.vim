...
-- cssProp: '@Identifier' # StorageClass
...
-- cssSelectorOp: '@Noise' # Special
-- cssSelectorOp2: '@Noise' # Special
-- cssAttrComma: '@Noise' # Special
...
-- cssFunctionComma: '@Noise' # Function
-- cssIdentifier: '@Operator' # Function
-- cssBraces: '@Noise' # Function
-- cssClassName: '@Operator' # Function
-- cssClassNameDot: '@Noise' # Function
