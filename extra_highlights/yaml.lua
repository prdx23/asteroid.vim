...
-- yamlTagHandle: '@Identifier' # String
-- yamlTagPrefix: '@Identifier' # String
-- yamlYAMLDirective: '' # yamlDirectiveName
-- yamlReservedDirective: '@SpellBad' # Error
...
-- yamlBlockMappingKey: '@Statement' # Identifier
-- yamlBlockMappingMerge: '' # Special
-- yamlFlowMappingKey: '@Statement' # Identifier
-- yamlFlowMappingMerge: '' # Special
-- yamlMappingKeyStart: '' # Special
-- yamlFlowIndicator: '' # Special
-- yamlKeyValueDelimiter: '@Special' # Special
-- yamlConstant: '' # Constant
-- yamlNull: '' # yamlConstant
-- yamlBool: '@Boolean' # yamlConstant
-- yamlAnchor: '' # Type
-- yamlAlias: '' # Type
-- yamlNodeTag: '' # Type
-- yamlInteger: '' # Number
-- yamlFloat: '' # Float
-- yamlTimestamp: '@Constant' # Number
